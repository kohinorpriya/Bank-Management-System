...
public class SignThree extends JFrame implements ActionListener{
    ...
    String formo;
     SignThree( String formo) {
         ...
         carddetail.setBounds(100, 330, 330,20);
         add(carddetail);
         ...
         pindetail.setBounds(100, 400, 330,20);
         add(pindetail);
         ...
         c4 = new JCheckBox("Email & SMS Alters");
         ...
         if(ae.getSource() == submit){
             ...
             try{
                 if(accountType.equals("")){
                     ...
                     String query = "insert into signupthree values('"+formo +"', '"+accountType+"' , '"+cardnumber+"' , '"+pinnumber+"' ,'"+facility+"')";
                     c.s.executeUpdate(query);
                     String query1 = "insert into login values('"+formo +"', '"+cardnumber+"' , '"+pinnumber+"')";
